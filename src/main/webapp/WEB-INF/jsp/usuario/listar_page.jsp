...
<main class="container-flex col-12">
    <div id="top" class="row d-flex align-items-baseline">
        ...
        <div class="col-md-3">
            <a href="/usuario/adicionar" class="btn btn-primary">Novo Usuário</a>
        </div>
    </div> <!-- /#top -->
    <hr>
                ...
                <tbody>
                    <c:forEach var="usuario" items="${usuarioList}">
                        <tr>
                            ...
                            <td>${usuario.email}</td>
                            <td class="actions">
                                <a class="btn btn-info btn-sm" href="/usuario/${usuario.email}/atualizar"
                                    data-bs-toggle="tooltip" data-bs-placement="top" title="Editar">
                                    <i class="bi bi-check-circle text-light"></i>
                                </a>
                                <a class="btn btn-danger btn-sm" href="#"
                                   data-bs-toggle="modal" data-bs-target="#confirm-delete-modal" data-href="/usuario/${usuario.email}/excluir"
