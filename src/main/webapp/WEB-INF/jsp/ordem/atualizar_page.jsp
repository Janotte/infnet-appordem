          ...
          >
            <fieldset>
              <div class="row align-items-center gx-2">
                <div class="form-floating col-md-2 mb-3">
                  <form:input
                    ...
                    readOnly="readOnly"
                  />
                  <form:label path="id" for="id" class="form-label ms-3"
                    >Id</form:label
                  >
                </div>
              ...
              <div class="form-floating mb-3">
                ...
                />
                <form:label path="problema" for="problema" class="form-label"
                  >Problema</form:label
                >
              </div>
              <div class="form-floating mb-3">
                <form:input
                  ...
                  placeholder="Solução"
                />
                <form:label path="solucao" for="solucao" class="form-label"
                  >Solução</form:label
                >
              </div>
              <table
                    ...
                    <tr>
                      ...
                      <td class="actions">
                        <a
                          ...
                          href="/ordem/produtos/${item.id}/atualizar"
                          data-bs-toggle="tooltip"
                          data-bs-placement="top"
                          title="Editar"
                        >
                        ...
                        <a
                          ...
                          data-href="/ordem/produtos/${item.id}/excluir"
                          data-bs-toggle="tooltip"
                          data-bs-placement="top"
                          title="Excluir"
                        >
