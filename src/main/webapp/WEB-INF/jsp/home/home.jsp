    ...
    <div class="container-fluid">
      ...
      <main class="container-flex col-12">
        <div id="list" class="row">
          ...
          <p class="ms-3">
            Projeto do Aplicativo de Gestão de Ordem de Serviço
          </p>
        </div>
        <hr />
            ...
            <table class="table table-striped" cellspacing="0" cellpadding="0">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>LocalDateTime</td>
                  <td colspan="2">
                    Data e hora de registro da ordem de serviço
                  </td>
                </tr>
                <tr>
                  <td>situcao</td>
                  <td>Situacao</td>
                  <td colspan="2">
                    Situação da ordem de serviço, podendo ser aberta, em analise
                    e concluída.
                  </td>
                </tr>
                <tr>
                  ...
                  <td>TipoAtendimento</td>
                  <td colspan="2">
                    O tipo de atendimento são interno, remoto ou externo
                  </td>
                </tr>
                <tr>
                  <td>equipamento</td>
                ...
                <tr>
                  ...
                  <td>String</td>
                  <td colspan="2">
                    Descrição do problema apresentado pelo equipamento
                  </td>
                </tr>
                <tr>
                  <td>solucao</td>
                ...
                <tr>
                  ...
                  <td>String</td>
                  <td colspan="2">
                    Espaço destinado para observações necessárias
                  </td>
                </tr>
              </tbody>
            </table>
        ...
        <div id="top" class="row">
          ...
          <div class="table-responsive col-md-12">
            <table class="table table-striped" cellspacing="0" cellpadding="0">
              <thead>
                <tr>
                  <th style="width: 20%" style="width: 20%" scope="col">
                    Atributo
                  </th>
                  <th style="width: 20%" scope="col">Tipo</th>
                  <th style="width: 60%" scope="col">Descrição</th>
