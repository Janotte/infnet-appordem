                ...
                <tbody>
                    <c:forEach var="licenca" items="${licencaList}">
                        <tr>
                            <td>${licenca.id}</td>
                            <td>${licenca.nome}</td>
                            <td><fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value="${licenca.precoVenda}" /></td>
                            <td class="actions">
                                <a class="btn btn-info btn-sm" href="/licenca/${licenca.id}/atualizar"
                                    data-bs-toggle="tooltip" data-bs-placement="top" title="Editar">
                                    <i class="bi bi-check-circle text-light"></i>
                                </a>
                                <a class="btn btn-danger btn-sm" href="#"
                                   data-bs-toggle="modal" data-bs-target="#confirm-delete-modal" data-href="/licenca/${licenca.id}/excluir"
