...
import br.edu.infnet.appordem.controller.ServicoController;
...
public class ServicoTeste implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        ServicoController.incluir(servico1);
        ...
        ServicoController.incluir(servico2);
        ...
        ServicoController.incluir(servico3);
    }
}
